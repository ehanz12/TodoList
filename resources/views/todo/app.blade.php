                                ...
                                <form action="{{route('todo.update', ['id' => $item->id]) }}" method="POST">
                                    ...
                                    <div class="d-flex">
                                        <div class="radio px-2">
                                            <label>
                                                <input type="radio" value="1" name="completed" {{ $item->completed == '1' ? 'checked' : '' }}> Selesai
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                                                <input type="radio" value="0" name="completed" {{ $item->completed == '0' ? 'checked' : '' }}> Belum
                                            </label>
                                        </div>
                                    </div>
                                </form>
